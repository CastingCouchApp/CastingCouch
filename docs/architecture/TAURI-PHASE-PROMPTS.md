...
| 4 UI | Shell; Alerts-Library-Table; Settings/Services; Overlay-Tabelle + Editor-WebView; Dashboard Live (Szene/Twitch/Now Playing, Events + 15s-Fallback); Updates/About; Theme-Tokens (`data-theme`) | Sidecar-UI, pixel-perfekte Themes |

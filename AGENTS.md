...
- Overlay-Widget-Skill (`.agents/skills/overlay-widget/`) stets mitpflegen, wenn sich der Ablauf oder die Dateien zum Einführen von Overlay-Widgets/Shapes ändern.
...
- Overlay-Widget-Skill canonical: `.agents/skills/overlay-widget/`; Pointer unter `.cursor/skills/overlay-widget` und `.codex/skills/overlay-widget`.

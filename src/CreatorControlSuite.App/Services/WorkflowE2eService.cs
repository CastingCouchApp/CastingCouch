...
public sealed class WorkflowE2eService(WorkflowModule workflow) : IWorkflowE2eService
{
    ...
    {
        DateTimeOffset started = DateTimeOffset.Now; var steps = new List<WorkflowE2eStepResult>();

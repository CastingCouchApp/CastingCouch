...
import { PARTNER_ROULETTE_TRANSITIONS, PARTNER_ROULETTE_OBJECT_POSITIONS } from "./widgets/partner-roulette";
...
import { CHAT_VARIANTS, CHAT_SIZE_PRESETS } from "./widgets/chat";
import {
...
const CcsCanvas = {
  ...
  PARTNER_ROULETTE_OBJECT_POSITIONS,
  GOAL_BAR_VARIANTS,

...
function ServicesPage() {
    ...
    const setScene = useMutation({
        mutationFn: (scene: string) =>
            tauriInvoke<void>("obs_set_scene", { scene }),
    });
                        ...
                        <div>
                            ...
                            svc.state !== "connected" ? (
                                <p className="mt-2 text-xs text-zinc-500">
                                    Automatisch verbinden ist aktiv — Start
                            ...
                            <div className="space-y-3">
                                <div className="flex flex-wrap gap-2">
                                    <Button
                                        ...
                                        disabled={
                                            connectObs.isPending ||
                                            svc.state === "connecting"
                                        }
                                    >
                                        Verbinden
                                    </Button>
